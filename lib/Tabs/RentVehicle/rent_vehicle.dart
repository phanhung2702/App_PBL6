...
import 'package:app_pbl6/Tabs/RentVehicle/driver_service_page.dart';
import 'package:app_pbl6/Tabs/RentVehicle/self_drive_page.dart';
...
class RentVehiclePage extends StatefulWidget {
  @override
  RentVehiclePageState createState() => RentVehiclePageState();
}

class RentVehiclePageState extends State<RentVehiclePage> {
  ...
  final List<String> rentVehicleImages = [
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
              ...
              child: Stack(
                children: [
                  PageView.builder(
                    ...
                    itemCount: rentVehicleImages.length,
                    itemBuilder: (context, index) {
                      return ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset(
                          rentVehicleImages[index],
                          fit: BoxFit.cover,
            ...
            SmoothPageIndicator(
              controller: _pageController,
              count: rentVehicleImages.length,
      ...
      Expanded(
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DriverServicePage()), // Điều hướng đến trang thuê xe tự lái
            );
          },
          child: Container(
            height: 120,
      ...
      Expanded(
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SelfDrivePage()), // Điều hướng đến trang thuê xe có tài xế
            );
          },
          child: Container(
            height: 120,
